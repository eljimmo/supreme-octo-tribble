...
import { HeroContainerCanva, HeroContainer, HeroContainer200, HeroContainerTransparent, HeroContainer400, HeroContent2, HeroContent3, HeroContent }  from "../HeroSection/HeroElements";
import "./styles.css"
    ...
    <>
      <Block factor={1} offset={0}>
        ...
        <Block factor={1.0}>
          ...
          the origins of neural networks are based on efforts to model information processing in biological systems.{mobile ? <br /> : " "}genetic representation is a way of presenting solutions/individuals in evolutionary computation methods.
          </Html>
        </Block>
      </Block>
...
export default function Moksha() {
