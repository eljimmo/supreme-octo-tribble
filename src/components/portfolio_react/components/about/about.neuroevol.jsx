...
const NeuroevolutionAbout = () => {
  return (

    <div id="about">
    <div>
      <Heading>Maximum Exploration and Ultimate Parallelization</Heading>
      <Subtitle>
    ...
    <div>
      <TopLine style={{ marginTop: "2rem" }}>Generative NeuroEvolution for Real Intelligence</TopLine>
...
export default NeuroevolutionAbout;
