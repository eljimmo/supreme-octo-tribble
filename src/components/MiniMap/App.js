...
import { useDrag } from "@use-gesture/react" // Import from "@use-gesture/react"
...
function Marker() {
  ...
  const bind = useDrag(
    ...
    {
      from: () => [(state.ref.scrollLeft * 0.5) / state.pages] // Change 'initial' to 'from'
    }
  )
...
// Rest of the components and functions remain the same
