...
function Images() {
  ...
  return (
    <group ref={group}>
      <Image position={[-2, 0, 0]} scale={[4, height, 1]} url="/10.jpg" />
      <Image position={[2, 0, 3]} scale={3} url="/10.jpg" />
      <Image position={[-2.05, -height, 6]} scale={[1, 3, 1]} url="/10.jpg" />
      <Image position={[-0.6, -height, 9]} scale={[1, 2, 1]} url="/10.jpg" />
