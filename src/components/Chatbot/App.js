    ...
    <div className="App">
        ...
        <div className="app-overview">
          ...
          <p className="app-paragraph">
            The AI bots work unnder the parameters given by the creator and with the data choosen. Utilizing the data and the parameters, the AI bots will be able to make predictions and give suggestions. 
          </p>
