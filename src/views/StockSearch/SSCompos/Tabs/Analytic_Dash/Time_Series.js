...
//           <Text weight={500}>Monte Carlo Simulations</Text>
...
//         <Text component="span" inherit color="blue">
//         Brownian motion will be the main driver for estimating the return.
//         </Text>{' '}
//         Monte Carlo Simulations are an incredibly powerful tool in numerous contexts, including operations research, game theory, physics, business and finance, among others.
//       </Text>
//       <Card.Section mt="sm">
//             </Card.Section>
...
// function Understanding_Time_Series() {
//   return (
//     <Card withBorder shadow="sm" radius="md">
//       <Card.Section withBorder inheritPadding py="xs">
//         <Group position="apart">
//           <Text weight={500}>Essential Components of Time Series Analysis </Text>
//           <Menu withinPortal position="bottom-end" shadow="sm">
//             <Menu.Target>
//               <ActionIcon>
//               </ActionIcon>
...
//       <Text mt="sm" color="dimmed" size="sm">
//         <Text component="span" inherit color="blue">
//         Time series forecasting is the prediction of future data after analyzing the past data for temporal trends.
//         </Text>{' '}
//         A pattern that is affected or influenced by seasonal frequency variations are termed to be seasonal.
//         By conducting a detailed analysis of these time series forecasting patterns, we can determine the future outcomes with the help of our constructive deep learning models.
...
//       <List.Item>Level: The average value in the time series</List.Item>
//       <List.Item>Trend: The increasing or decreasing value in the time series.</List.Item>
//       <List.Item>Seasonality: The repeating short-term cycle in the time series.</List.Item>
//       <List.Item>Noise: The random variation in the time series.</List.Item>
//     </List> */}
//             </Card.Section>
//       <Card.Section inheritPadding mt="sm" pb="md">
...
//       <Card.Section withBorder inheritPadding py="xs">
//         <Group position="apart">
//           <Text weight={500}>Compute the logarithmic returns Daily Chart </Text>
//           <Menu withinPortal position="bottom-end" shadow="sm">
//             <Menu.Target>
//               <ActionIcon>
//               </ActionIcon>
...
//         </Text>{' '}
//       Utilizing the log returns, we can compute the daily returns.
//       </Text>
...
//       <Card.Section withBorder inheritPadding py="xs">
//         <Group position="apart">
//           <Text weight={500}> Compute the Variance and Daily Returns</Text>
//           <Menu withinPortal position="bottom-end" shadow="sm">
//             <Menu.Target>
//               <ActionIcon>
//               </ActionIcon>
...
//       <Card.Section withBorder inheritPadding py="xs">
//         <Group position="apart">
//           <Text weight={500}>Confidence Intervals and Cumulative Returns
//           </Text>
//           <Menu withinPortal position="bottom-end" shadow="sm">
//             <Menu.Target>
//               <ActionIcon>
...
//       <Text mt="sm" color="dimmed" size="sm">
//         <Text component="span" inherit color="blue">
//         Data provided by the IEXCloud team.
//         </Text>{' '}
//         By analyzing a stocks simulated returns with confidence levels we can better understand a stocks abilty to draw a positive return in a distribution set.   
//         </Text>
