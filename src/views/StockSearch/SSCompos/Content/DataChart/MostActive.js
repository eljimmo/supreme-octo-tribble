...
// import Chart from "./Most_Chart.js";
...
//     const percentageChange = `https://cloud.iexapis.com/stable/stock/${symbol}/quote?displayPercent=true&token=pk_0e682b29c77d48f9804e3dd05453bf0e`;
...
//   }
//   getStocksList() {
//     const stocks = `https://cloud.iexapis.com/stable/stock/market/list/mostactive?token=pk_0e682b29c77d48f9804e3dd05453bf0e`;
//     fetch(stocks)
//       .then(res => res.json())
//       .then(result => {
//         const gainers = `https://cloud.iexapis.com/stable/stock/market/list/gainers?token=pk_0e682b29c77d48f9804e3dd05453bf0e`;
//         let counter = 0;
//         fetch(gainers)
//           .then(res => res.json())
//           .then(result => {
...
//                   stockListTickers[parseInt(i)]
//                 }/quote?displayPercent=true&token=pk_0e682b29c77d48f9804e3dd05453bf0e`;
...
//     const lastPrice = `https://cloud.iexapis.com/stable/stock/${symbol}/quote?displayPercent=true&token=pk_0e682b29c77d48f9804e3dd05453bf0e`;
//     fetch(lastPrice)
//       .then(res => res.json())
//       .then(result => {
